...
// It is asoociated with Department class through its Object(s).
class Institute {
...
class Test {
    public static void main (String[] args) {
        Student s1 = new Student("a", 1, "CSE");
        Student s2 = new Student("b", 2, "CSE");
        Student s3 = new Student("c", 1, "EE");
        Student s4 = new Student("d", 2, "EE");
